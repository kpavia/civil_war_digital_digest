...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/css/v3-episodes-sheet.css" >
                ...
                <section class="col-sm-8 text-left" id="main-content-section">
                    ...
                    <div class="container-fluid episodes" id="episodes-div">
                        ...
                        <div class="container-fluid episode-div" id="v3e1-div">
                            ...
                            <a href="https://www.youtube.com/watch?v=4erfTAS4AOE&list=PLm0U6xIHaOs-vdgbVEKc3ANaaM8DrwfpW&index=1" target="_blank">
                        ...
                        <div class="container-fluid episode-div" id="v3e20-div">
                            <p class="popup" onclick="popup()" id="episode-twenty-pop">Episode 20: Auror GAR Hall & Museum
                                <span class="popuptext" id="episode-twenty-slugline">Visit the Aurora GAR Hall & Museum</span>
                            </p>
                            <a href="https://www.youtube.com/watch?v=yEjqvPH_xz4" target="_blank">
                        ...
                        <div class="container-fluid episode-div" id="v3e23-div">
                            <p class="popup" onclick="popup()" id="episode-twentythree-pop">Episode 23: Bubble & Squeak
                                <span class="popuptext" id="episode-twentythree-slugline">Bubble and Squeak.</span>
                            </p>
                            <a href="https://www.youtube.com/watch?v=D5hwfbLOM6U" target="_blank">
