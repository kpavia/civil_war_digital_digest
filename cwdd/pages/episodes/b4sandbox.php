                ...
                <div class="col-md-8 col-lg-8" id="content">
                    <div class="row">
                        <div class="col-12 center">
                            <h1 id="header-title">General Store</h1>
                            <br>
                            <p>
                                We have searched Amazon and found many ration and other items that can be useful for the living historian.
                    ...
                    <div class="row">
                        <div class="col-12 center">
                            ...
                            <ul id="tools-ul-list">
                                ...
                                <li>
                                    <a href="https://amzn.to/2NxEO3v" target="_blank">
                                        Diamond Green Strike Anywhere Matches
                                    </a>
                                </li>
                            </ul>
                            <br>
                            <h2 class="underline">Sundries</h2>
